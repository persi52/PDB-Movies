...
import { Notifications,  Home, Login, Registration, Player, Navigation, Footer,Navbar_logged, HomeNotLogged, UserPage, Favourites, Profile, EditProfile, Search} from "./components";
      ...
      <div className="App">
        <Router>
          ...
          <Switch>
            ...
            <Route path="/editprofile" exact component={(props) => <EditProfile {...props} />} />
            <Route path="/confirmation" exact component={() => <RegistrationConfirmation />} />
            <Route path="/myprofile" exact component={(props) => <UserPage {...props} />} />
